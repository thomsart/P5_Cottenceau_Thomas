...
def main():
    ...
    """ Once created we fill 'product' table wich contains all products from
    the API With the methode 'fill_table' of the object 'database'.
    Here for exempe we pick all cornflakes, pizza, camembert and conichon.
    now you have to connect to the database as 'client' with the code
    'thecode'. Here we just took four differents foods for the exemple but
    you can take what you want. You put in first argument the food you selected
    and in the second, the quantity of pages for this food on the API. """
